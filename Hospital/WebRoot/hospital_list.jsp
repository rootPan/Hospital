        ...
        <header id="fastTop" class="header" style="height: 100px;">
            ...
            <div class="keyword">
                <form method="post" id="med_form" action="selHosp" onKeyDown="if(event.keyCode==13)return false;">
                    <input type="text" name="hname" autocomplete="off" placeholder="请输入医院名称" id="search-tips-input" value="">
                ...
                <div class="content-left">
                    <div class="depart-select" style="padding-top: 0;">
                        <div class="select-detail hospital-level" data-type="3">
                            <h4>医院级别:</h4>
                            <ul class="dropmenus">
                                <li id="grade0" data-value="0" class="select-cur"><a href="sel_Hospitalsg">全部</a></li>
                                <li id="grade1" data-value="12"><a href="sel_Hospitalsg?grade=三甲">三甲医院</a></li>
                                <li id="grade2" data-value="12"><a href="sel_Hospitalsg?grade=三乙">三乙医院</a></li>
                                <li id="grade3" data-value="9,10,11,12"><a href="sel_Hospitalsg?grade=二甲">二甲医院</a></li>
                                <li id="grade4" data-value="5,6,7,8"><a href="sel_Hospitalsg?grade=二乙">二级医院</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="sort-container">
                        <p class="fl">为您找到<em id="hos_region">武汉</em>共<label class="curdotor"><i id="hos_total">${count}</i></label>家医院</p>
                   	...
                   	<li class="hospital-info-li">
                        <div class="hospital-info">
                            <div class="hospital-pic">
                                <a target="_blank" href="#"> <img class="fl" src="images/09fa513d269759eeaac0c0eeb5fb43166d22df07.jpg"></a>
                            </div>
                            <div class="hospital-introduces fl">
                                <div class="introduces-title"><a href="#">${hospitals.hname}</a><span class="hospital-sign">${hospitals.grade}</span><span class="hospital-health">医保</span></div>
                                ...
                                <label>有优质医生<span>${hospitals.count}</span>人<span><table cellspacing="0" cellpadding="0">
                                    <tbody>
                                        <tr>
                                            <td valign="top" class="first-child">医院地址: </td>
                                            <td class="info-pos last-child">
                                                <p class="address">${hospitals.address}</p>
                            ...
                            <div class="server-but fr">
                                <p><a href="selHname?hname=${hospitals.hname}" target="_blank">预约挂号</a></p>
                            </div>
                        </div>
                    </li>
                   </c:forEach>
